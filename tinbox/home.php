    ...
    <div id="myCarousel" class="carousel slide">
      <div class="carousel-inner">
        <div class="item active">
          <div class="img" style="background-image:url(images/slides-2016-01.jpg)"></div>
        </div>
        <div class="item">
          <div class="img" style="background-image:url(images/slides-2016-02.jpg)"></div>
        </div>
        <div class="item">
          <div class="img" style="background-image:url(images/slides-2016-03.jpg)"></div>
        </div>
        <div class="item">
          <div class="img" style="background-image:url(images/slides-2016-04.jpg)"></div>
        </div>
        <div class="item">
          <div class="img" style="background-image:url(images/slides-2016-05.jpg)"></div>
        </div>
        <div class="item">
          <div class="img" style="background-image:url(images/slides-2016-06.jpg)"></div>
        </div>
        <div class="item">
          <div class="img" style="background-image:url(images/slides-2016-07.jpg)"></div>
        </div>
        <div class="item">
          <div class="img" style="background-image:url(images/slides-2016-08.jpg)"></div>
        </div>
        <div class="item">
          <div class="img" style="background-image:url(images/slides-2016-09.jpg)"></div>
        </div>
        <div class="item">
          <div class="img" style="background-image:url(images/slides-2016-10.jpg)"></div>
        </div>
      </div>
