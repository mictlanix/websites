...
(function($) {
  ...
  function ResizeAnimation(img_container, direction) {
  ...
  function NoneAnimation(img_container, direction) {
  ...
  AdGallery.prototype = {
      ...
      var inter = setInterval(
        function() {
          if(thumb_count == thumbs_loaded) {
            ...
            var i = 1;
            var last_width = list.width();
            while(i < 201) {
              list.css('width', (thumb_wrapper_height + i) +'px');
              if(last_width != list.width()) {
                break;
              }
    ...
    initBackAndForward: function() {
      ...
      $(this.scroll_back).add(this.scroll_forward).click(
        function() {
          // We don't want to jump the whole height, since an image
    ...
    highLightThumb: function(thumb) {
      ...
      top -= (this.nav_display_height - thumb[0].offsetHeight) / 2;
